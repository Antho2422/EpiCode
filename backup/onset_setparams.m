...
config{4}.imagesavedir        = fullfile(imagesavedir, 'pat_02379_0828_Crise2_mHaBg');
...
config{4}.lfp.channel         = {'_HaBg_'};       %name the macro contact in the SOZ
...
config{5}.imagesavedir        = fullfile(imagesavedir, 'pat_02599_1057_Crise1_mHaT2');
...
config{5}.lfp.channel         = {'_HaT2_'};       %name the macro contact in the SOZ
...
config{7}.imagesavedir        = fullfile(imagesavedir, 'pat_02599_1057_Crise3_mHaT2');
...
config{8}.imagesavedir        = fullfile(imagesavedir, 'pat_03046_1482_Crise1_mHaT2');
...
config{9}.imagesavedir        = fullfile(imagesavedir, 'pat_03046_1482_Crise2_mHaT2');
...
config{11}.imagesavedir        = fullfile(imagesavedir, 'pat_03046_1482_Crise4_mHaT2');
...
config{11}.lfp.channel         = {'_HaT2_'};       %name the macro contact in the SOZ
...
config{12}.imagesavedir        = fullfile(imagesavedir, 'pat_03046_1482_Crise1_mHmT2');
...
config{12}.lfp.channel         = {'_HmT2_'};       %name the macro contact in the SOZ
...
config{13}.imagesavedir        = fullfile(imagesavedir, 'pat_03046_1482_Crise2_mHmT2');
...
config{13}.lfp.channel         = {'_HmT2_'};       %name the macro contact in the SOZ
...
config{14}.imagesavedir        = fullfile(imagesavedir, 'pat_03046_1482_Crise4_mHmT2');
...
config{14}.lfp.channel         = {'_HmT2_'};       %name the macro contact in the SOZ
...
config{15}.imagesavedir        = fullfile(imagesavedir, 'pat_02614_1073_Crise1_mTNmi');
...
config{15}.lfp.channel         = {'_TNmi_'};       %name the macro contact in the SOZ
...
config{16}.imagesavedir        = fullfile(imagesavedir, 'pat_02614_1073_Crise2_mTNmi');
...
config{16}.lfp.channel         = {'_TNmi_'};       %name the macro contact in the SOZ
...
config{23}.imagesavedir        = fullfile(imagesavedir, 'pat_02141_0579_Crise1_mHaT1');
...
config{23}.lfp.channel         = {'_HaT1_'};       %name the macro contact in the SOZ
...
config{24}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise2_mHa2g');
...
config{24}.lfp.channel         = {'_Ha2g_'};       %name the macro contact in the SOZ
...
config{25}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise3_mHa2g');
...
config{26}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise4_mHa2g');
...
config{26}.lfp.channel         = {'_Ha2g_'};       %name the macro contact in the SOZ
...
config{27}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise7_mHa2g');
...
config{27}.lfp.channel         = {'_Ha2g_'};       %name the macro contact in the SOZ
...
config{28}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise11_mHa2g');
...
config{28}.lfp.channel         = {'_Ha2g_'};       %name the macro contact in the SOZ
...
config{29}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise12_mHa2g');
...
config{29}.lfp.channel         = {'_Ha2g_'};       %name the macro contact in the SOZ
...
config{30}.imagesavedir        = fullfile(imagesavedir, 'pat_02660_1136_Crise13_mHa2g');
...
config{30}.lfp.channel         = {'_Ha2g_'};       %name the macro contact in the SOZ
